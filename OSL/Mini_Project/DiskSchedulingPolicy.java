...
class DSP_Algorithms {
    ...
    void printAverageSeekTime(int totalHeadMovement, int totalLength) {
        System.out.println("\n\n\tAverage Seek Time: " + (totalHeadMovement) + " / " + (totalLength) + " = "
                + ((double) totalHeadMovement / (double) totalLength));
    }
    ...
    void FCFS() {
        ...
        for (int i = 0; i < requestQueue.length; ++i) {
            ...
            System.out.println(
                    "\t" + (i + 1) + "\t\t" + currentHead + "\t\t" + currentDiskMovement + "\t\t" + totalHeadMovement);
        }
        System.out.println("------------------------------------------------------------------------");
    ...
    void SCAN() {
        ...
        if (outer == 0) {
            for (int i = firstHalf.size() - 1; i >= 0; --i) {
                ...
                System.out.println("\t" + (++j) + "\t\t" + currentHead + "\t\t" + currentDiskMovement + "\t\t"
                        + totalHeadMovement);
            }
            ...
            System.out.println(
                    "\t" + (++j) + "\t\t" + 199 + "\t\t" + Math.abs(currentHead - 199) + "\t\t" + totalHeadMovement);
            currentHead = 199;
    ...
    void CSCAN() {
        // "requestQueue.length + 2" since, both the extra ends will be added to the
        // queue;
